...
@Component({
  selector: 'app-lista-mapa-estacionamiento',
  templateUrl: './lista-mapa-estacionamiento.component.html',
  styleUrls: ['./lista-mapa-estacionamiento.component.css']
})
export class ListaMapaEstacionamientoComponent implements OnInit{
  map!: L.Map;
  markers: L.Marker[] = [];
  role: string = '';
